...
LOWEST_TRANSFORMERS_VERSION = dict(
    ...
    DeepseekV3ForCausalLM=digit_version('4.40'),
)
...
ATTN_DISPATCH_MAPPING = dict(
    ...
    DeepseekV3FlashAttention2=LazyObject(
        'xtuner.model.modules.dispatch.deepseek_v3', 'deepseek_attn_forward'),
)
...
VARLEN_ATTN_DISPATCH_MAPPING = dict(
    ...
    DeepseekV3FlashAttention2=LazyObject(
        'xtuner.model.modules.dispatch.deepseek_v3',
        'deepseek_varlen_attn_forward'),
)
